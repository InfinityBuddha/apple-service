        ...
        <Tabs>
          <Tabs className={tabs.reactTabs}>
            <TabList className={tabs.list}>
              ...
              <Tab className={tabs.item} selectedClassName={tabs.activeTab}>iPhone 8</Tab>
              <Tab className={tabs.item} selectedClassName={tabs.activeTab}>iPhone 8 Plus</Tab>
              <Tab className={tabs.item} selectedClassName={tabs.activeTab}>iPhone X</Tab>
            </TabList>
